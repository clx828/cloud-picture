...
/** getSpaceVOPage POST /api/space/get/vo/page */
export async function getSpaceVoPageUsingPost(
  body: API.SpaceQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePageSpaceVO_>('/api/space/get/vo/page', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** getSpaceLevelList GET /api/space/level/list */
export async function getSpaceLevelListUsingGet(options?: { [key: string]: any }) {
  return request<API.BaseResponseListSpaceLevel_>('/api/space/level/list', {
    method: 'GET',
    ...(options || {}),
  })
}
