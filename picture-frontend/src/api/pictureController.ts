...
/** getPictureVOByPageWithCache POST /api/picture/list/page/vo/cache */
export async function getPictureVoByPageWithCacheUsingPost(
  body: API.PictureQueryRequest,
  options?: { [key: string]: any }
) {
...
/** getPictureTagCategory GET /api/picture/tag_category */
export async function getPictureTagCategoryUsingGet(options?: { [key: string]: any }) {
